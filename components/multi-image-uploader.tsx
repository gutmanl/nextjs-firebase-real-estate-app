...
export default function MultiImageUploader({images = [], onImagesChange, urlFormatter} : Props) {
    ...
    const handleDragEnd = (result: DropResult) => {
        ...
        //Necessary to make that an assignment-by-copy
    ...
    return (
        <div className={"w-full max-w-3xl mx-auto p-4"}>
            <input className={"hidden"} ref={uploadInputRef} type="file"
                                    ...
                                    {(provided) => (
                                        <div {...provided.draggableProps}
                                         ...
                                         className={"relative p-2"}>
                                            <div className="bg-grey-100 rounded-lg flex gap-2 items-center overflow-hidden">
